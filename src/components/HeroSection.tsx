...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-gradient-to-br from-accent via-white to-muted pt-16">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-10"></div>
      <div className="container-custom relative z-10 flex flex-col items-start justify-center py-20">
        <div className="max-w-2xl">
          ...
          <h1 className="heading-xl mb-6 leading-tight">
            Bringing Your <span className="text-primary">Creative</span> Ideas to Life
          </h1>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#gallery" className="text-gray-500 hover:text-primary">
          <svg
